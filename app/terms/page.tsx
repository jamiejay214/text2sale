    ...
    <main className="min-h-screen bg-zinc-950 text-white">
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-6 text-[15px] leading-relaxed text-zinc-300">
          ...
          <h2 className="text-xl font-semibold text-white pt-4">Platform Overview &amp; Account</h2>
          ...
          <h2 className="text-xl font-semibold text-white pt-4">Platform Role &amp; Disclaimer</h2>
          ...
          <h2 className="text-xl font-semibold text-white pt-4">Account Suspension &amp; Termination</h2>
          ...
          <h2 className="text-xl font-semibold text-white pt-4">Compliance Tools</h2>
          ...
          <h2 className="text-xl font-semibold text-white pt-4">Disclaimer of Warranties</h2>
          ...
          <h2 className="text-xl font-semibold text-white pt-4">Governing Law</h2>
